...
public class Laptop {
	...
	@NotEmpty(message="Provide value for laptop brand")
	@Column(length = 25)
    private String brand;
	
	@NotEmpty(message="Provide value for laptop model")
	@Column(length = 25)
	...
	@Positive(message="Rental price should be greater than zero")
    private double rentalPrice;
	
	@NotEmpty(message="Provide value for availability status")
	@Column(length = 25)
